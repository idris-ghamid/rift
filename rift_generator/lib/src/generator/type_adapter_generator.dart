...
import 'package:rift_generator/src/adapter_builder/class_adapter_builder.dart';
import 'package:rift_generator/src/adapter_builder/enum_adapter_builder.dart';
import 'package:rift_generator/src/helper/helper.dart';
import 'package:rift_generator/src/helper/type_helper.dart';
import 'package:rift_generator/src/model/rift_schema.dart';
import 'package:source_gen/source_gen.dart';
import 'package:source_helper/source_helper.dart';
import 'package:meta/meta.dart';

class TypeAdapterGenerator extends GeneratorForAnnotation<RiftType> {
  @override
  ...
  static GetAccessorsResult getAccessors({
    ...
    final newSchemaFields = <String, RiftSchemaField>{};
    ...
    AdapterField? accessorToField(PropertyAccessorElement? element) {
      ...
      final annotation =
          getRiftFieldAnn(element.variable) ?? getRiftFieldAnn(element);
      ...
      if (schema != null) {
        ...
        throw RiftError('No index found');
      }

      newSchemaFields[name] = RiftSchemaField(index: index);
      return AdapterField(
        element,
        index,
        name,
    ...
    final newSchema = RiftSchemaType(
      typeId: typeId,
      nextIndex: nextIndex,
...
class GetAccessorsResult {
  ...
  /// The Rift schema generated for the class
