...
abstract class IsolatedRiftInterface implements TypeRegistry {
  /// Initialize the isolated Rift instance
  ///
  /// If accessing Rift in multiple isolates, an [isolateNameSever] MUST be
