...
export 'package:rift/src/backend/stub/backend_manager.dart'
    if (dart.library.io) 'package:rift/src/backend/vm/backend_manager.dart'
    if (dart.library.js_interop) 'package:rift/src/backend/js/backend_manager.dart';
