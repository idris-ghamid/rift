...
import 'package:rift/src/binary/raw_object_reader.dart';
import 'package:rift/src/binary/raw_object_writer.dart';
...
void main() {
  ...
  group('external adapter', () {
    test('with schema', () {
      ...
      final types = {
        'TestObject': RiftSchemaType(
          typeId: 100,
          nextIndex: 0,
          fields: {
            'field1': RiftSchemaField(index: 0),
            'field2': RiftSchemaField(index: 1),
          },
        ),
      };
    ...
    test('enum', () {
      ...
      final types = {
        'TestEnum': RiftSchemaType(
          typeId: 100,
          nextIndex: 0,
          fields: {
            'value1': RiftSchemaField(index: 0),
            'value2': RiftSchemaField(index: 1),
          },
        ),
      };
...
class TestAdapter extends TypeAdapter<TestObject> {
  ...
  TestObject read(BinaryReader reader) {
    ...
    return TestObject(fields[0] as String, (fields[1] as num).toInt());
  }
