...
For Flutter apps, also add the Flutter integration:
...
For code generation (optional but recommended for type safety):
...
Rift includes **75+ features** across 6 priority levels:
...
| 🔵 Future | 17 | Time-Series, Graph Schema, Smart Codegen, Profiler, Testing Utils, Field-Level Encryption, Cross-Box Tx, Bloom Filters, Background Compaction, Aurora OS, Reactive Signals, Incremental Export, mmap, Extension Types, SharedArrayBuffer, Hive Migration, Plugin Architecture |
| 🟣 Advanced | 20 | Observable Store, Data Masking, Schema Validation, Snapshot Isolation, Rate Limiting, Data Versioning, Partitioning, Observability/Metrics, Transform Pipeline, Replication, Connection Pooling, Data Sanitization, Event Sourcing, Reactive Forms, Adaptive Caching, Dictionary Compression, Access Control, Data Diff & Patch, Lazy Loading Strategies, Query Optimization |
...
|---------|-------------|-----|
| `rift` | Core database library | [![rift](https://img.shields.io/badge/pub.dev-rift-blue.svg)](https://pub.dev/packages/rift) |
| `rift_flutter` | Flutter integration (init, adapters, extensions) | [![rift_flutter](https://img.shields.io/badge/pub.dev-rift__flutter-blue.svg)](https://pub.dev/packages/rift_flutter) |
| `rift_generator` | Code generation for typed boxes | [![rift_generator](https://img.shields.io/badge/pub.dev-rift__generator-blue.svg)](https://pub.dev/packages/rift_generator) |
| `rift_inspector` | DevTools inspector UI | [![rift_inspector](https://img.shields.io/badge/pub.dev-rift__inspector-blue.svg)](https://pub.dev/packages/rift_inspector) |
