...
class ClassAdapterBuilder extends AdapterBuilder {
  ...
  /// [TypeChecker] for [RiftList].
  final RiftListChecker =
      const TypeChecker.typeNamed(RiftList, inPackage: 'rift');
  ...
  String _cast(DartType type, String variable) {
    ...
    if (RiftListChecker.isAssignableFromType(type)) {
      return '($variable as RiftList$suffix)$suffix.castRiftList()';
