...
/// Generate the RiftRegistrar for the entire project
...
''');
    ...
    buffer.writeln("import 'package:rift/rift.dart';");
...
extension HiveRegistrar on RiftInterface {
...
extension IsolatedHiveRegistrar on IsolatedRiftInterface {
  void registerAdapters() {
''');
