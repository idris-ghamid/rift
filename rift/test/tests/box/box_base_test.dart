  ...
  group('BoxBase', () {
    ...
    group('.keys', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(() => box.keys, throwsRiftError(['closed']));
      });
    });
    ...
    group('.length / .isEmpty / .isNotEmpty', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(() => box.length, throwsRiftError(['closed']));
        expect(() => box.isEmpty, throwsRiftError(['closed']));
        expect(() => box.isNotEmpty, throwsRiftError(['closed']));
      });
    });
    ...
    group('.watch()', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(box.watch, throwsRiftError(['closed']));
      });
    });
    ...
    group('.keyAt()', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(() => box.keyAt(0), throwsRiftError(['closed']));
      });
    });
    ...
    group('.containsKey()', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(() => box.containsKey(0), throwsRiftError(['closed']));
      });
    });
    ...
    group('.clear()', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(box.clear, throwsRiftError(['closed']));
      });
    });
    ...
    group('.compact()', () {
      ...
      test('throws if box is closed', () async {
        ...
        final box = _openBoxBaseMock(backend: backend);
        await box.close();
        expect(box.compact, throwsRiftError(['closed']));
      });
    });
