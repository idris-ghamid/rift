...
import 'package:rift_generator/src/model/registrar_intermediate.dart';
...
class RegistrarIntermediateBuilder implements Builder {
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    for (final annotatedElement in RiftTypeElements) {
    ...
    final generateAdaptersChecker =
        TypeChecker.typeNamed(GenerateAdapters, inPackage: 'rift');
